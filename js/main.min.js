! function (e, t) {
    ...
    function h() {
        ne.removeEventListener("DOMContentLoaded", h), e.removeEventListener("load", h), fe.ready()
    }
    ...
    function m(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            r = We[i];
        return r || (t = n.body.appendChild(n.createElement(i)), r = fe.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), We[i] = r, r)
    }

    function v(e, t) {
        for (var n, i, r = [], s = 0, o = e.length; s < o; s++) i = e[s], i.style && (n = i.style.display, t ? ("none" === n && (r[s] = qe.get(i, "display") || null, r[s] || (i.style.display = "")), "" === i.style.display && Me(i) && (r[s] = m(i))) : "none" !== n && (r[s] = "none", qe.set(i, "display", n)));
    ...
    function x(e, t, n, i, r) {
        for (var s, o, a, l, c, u, h = t.createDocumentFragment(), p = [], d = 0, f = e.length; d < f; d++)
            if ((s = e[d]) || 0 === s)
                if ("object" === fe.type(s)) fe.merge(p, s.nodeType ? [s] : s);
                else if (Qe.test(s)) {
            for (o = o || h.appendChild(t.createElement("div")), a = (Ue.exec(s) || ["", ""])[1].toLowerCase(), l = Ve[a] || Ve._default, o.innerHTML = l[1] + fe.htmlPrefilter(s) + l[2], u = l[0]; u--;) o = o.lastChild;
            fe.merge(p, o.childNodes), o = h.firstChild, o.textContent = ""
        } else p.push(t.createTextNode(s));
        for (h.textContent = "", d = 0; s = p[d++];)
            if (i && fe.inArray(s, i) > -1) r && r.push(s);
            else if (c = fe.contains(s.ownerDocument, s), o = y(h.appendChild(s), "script"), c && w(o), n)
            for (u = 0; s = o[u++];) Xe.test(s.type || "") && n.push(s);
        return h
    }
    ...
    function D(e, t) {
        var n, i, r, s, o, a, l, c;
        if (1 === t.nodeType) {
            if (qe.hasData(e) && (s = qe.access(e), o = qe.set(t, s), c = s.events)) {
    ...
    function A(e, t, i, r) {
        ...
        var s, o, a, l, c, u, h = 0,
            ...
            f = t[0],
            g = fe.isFunction(f);
        if (g || p > 1 && "string" == typeof f && !de.checkClone && tt.test(f)) return e.each(function (n) {
            var s = e.eq(n);
            g && (t[0] = f.call(this, n, s.html())), A(s, t, i, r)
        });
        if (p && (s = x(t, e[0].ownerDocument, !1, e, r), o = s.firstChild, 1 === s.childNodes.length && (s = o), o || r)) {
            for (a = fe.map(y(s, "script"), S), l = a.length; h < p; h++) c = s, h !== d && (c = fe.clone(c, !0, !0), l && fe.merge(a, y(c, "script"))), i.call(e[h], c, h);
            if (l)
                for (u = a[a.length - 1].ownerDocument, fe.map(a, k), h = 0; h < l; h++) c = a[h], Xe.test(c.type || "") && !qe.access(c, "globalEval") && fe.contains(u, c) && (c.src ? fe._evalUrl && fe._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }

    function N(e, t, n) {
        for (var i, r = t ? fe.filter(t, e) : e, s = 0; null != (i = r[s]); s++) n || 1 !== i.nodeType || fe.cleanData(y(i)), i.parentNode && (n && fe.contains(i.ownerDocument, i) && w(y(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function $(e, t, n) {
        var i, r, s, o, a = e.style;
        return n = n || ot(e), n && (o = n.getPropertyValue(t) || n[t], "" !== o || fe.contains(e.ownerDocument, e) || (o = fe.style(e, t)), !de.pixelMarginRight() && st.test(o) && rt.test(t) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s)), void 0 !== o ? o + "" : o
    }
    ...
    function H(e) {
        var t = fe.cssProps[e];
        return t || (t = fe.cssProps[e] = q(e) || e), t
    }
    ...
    function P(e, t, n, i, r) {
        var s, o = 0;
        for (s = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; s < 4; s += 2) "margin" === n && (o += fe.css(e, n + Re[s], !0, r)), i ? ("content" === n && (o -= fe.css(e, "padding" + Re[s], !0, r)), "margin" !== n && (o -= fe.css(e, "border" + Re[s] + "Width", !0, r))) : (o += fe.css(e, "padding" + Re[s], !0, r), "padding" !== n && (o += fe.css(e, "border" + Re[s] + "Width", !0, r)));
        return o
    }
    ...
    function z(e, t, n) {
        ...
        return st.test(s) ? s : (i = o && (de.boxSizingReliable() || s === e.style[t]), "auto" === s && (s = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = parseFloat(s) || 0) + P(e, t, n || (o ? "border" : "content"), i, r) + "px")
    }
    ...
    function R() {
        ft && (!1 === ne.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(R) : e.setTimeout(R, fe.fx.interval), fe.fx.tick())
    }
    ...
    function W(e, t, n) {
        for (var i, r = (X.tweeners[t] || []).concat(X.tweeners["*"]), s = 0, o = r.length; s < o; s++)
            if (i = r[s].call(n, t, e)) return i
    }

    function B(e, t, n) {
        var i, r, s, o, a, l, c, u, h = "width" in t || "height" in t,
            p = this,
            d = {},
            f = e.style,
            g = e.nodeType && Me(e),
            m = qe.get(e, "fxshow");
        n.queue || (o = fe._queueHooks(e, "fx"), null == o.unqueued && (o.unqueued = 0, a = o.empty.fire, o.empty.fire = function () {
            o.unqueued || a()
        ...
        for (i in t)
            ...
            h && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = m && m.display, null == c && (c = qe.get(e, "display")), u = fe.css(e, "display"), "none" === u && (c ? u = c : (v([e], !0), c = e.style.display || c, u = fe.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === fe.css(e, "float") && (l || (p.done(function () {
                f.display = c
    ...
    function X(e, t, n) {
        var i, r, s = 0,
            ...
            l = function () {
                if (r) return !1;
                for (var t = dt || M(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, s = 1 - i, o = 0, l = c.tweens.length; o < l; o++) c.tweens[o].run(s);
        ...
        for (U(u, c.opts.specialEasing); s < o; s++)
            if (i = X.prefilters[s].call(c, e, u, c.opts)) return fe.isFunction(i.stop) && (fe._queueHooks(c.elem, c.opts.queue).stop = fe.proxy(i.stop, i)), i;
        return fe.map(u, W, c), fe.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), fe.fx.timer(fe.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    fe.fn = fe.prototype = {
        ...
        var e, t, n, i, r, s, o = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof o && (c = o, o = arguments[a] || {}, a++), "object" == typeof o || fe.isFunction(o) || (o = {}), a === l && (o = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = o[t], i = e[t], o !== i && (c && i && (fe.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, s = n && Array.isArray(n) ? n : []) : s = n && fe.isPlainObject(n) ? n : {}, o[t] = fe.extend(c, s, i)) : void 0 !== i && (o[t] = i));
        return o
    }, fe.extend({
        ...
        map: function (e, t, n) {
            var r, s, o = 0,
                a = [];
            if (i(e))
                for (r = e.length; o < r; o++) null != (s = t(e[o], o, n)) && a.push(s);
            else
        ...
        proxy: function (e, t) {
            var n, i, r;
            if ("string" == typeof t && (n = e[t], t = e, e = n), fe.isFunction(e)) return i = re.call(arguments, 2), r = function () {
    ...
    var we = function (e) {
        function t(e, t, n, i) {
            var r, s, o, a, l, u, p, d = t && t.ownerDocument,
                f = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== f && 9 !== f && 11 !== f) return n;
            if (!i && ((t ? t.ownerDocument || t : F) !== N && A(t), t = t || N, L)) {
                if (11 !== f && (l = ge.exec(e)))
                    if (r = l[1]) {
                        if (9 === f) {
                            if (!(o = t.getElementById(r))) return n;
                            if (o.id === r) return n.push(o), n
                        } else if (d && (o = d.getElementById(r)) && P(t, o) && o.id === r) return n.push(o), n
                    } else {
                    ...
                    if (1 !== f) d = t, p = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(we, xe) : t.setAttribute("id", a = z), u = T(e), s = u.length; s--;) u[s] = "#" + a + " " + h(u[s]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function (t, n, r) {
                ...
                if (l) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || o)
                            if (h = t[z] || (t[z] = {}), u = h[t.uniqueID] || (h[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;
                            else {
                                if ((c = u[s]) && c[0] === R && c[1] === a) return p[2] = c[2];
        ...
        function m(e, t, n, r, s, o) {
            return r && !r[z] && (r = m(r)), s && !s[z] && (s = m(s, o)), i(function (i, o, a, l) {
                var c, u, h, p = [],
                    d = [],
                    m = o.length,
                ...
                if (i) {
                    if (s || e) {
                        ...
                        for (u = w.length; u--;)(h = w[u]) && (c = s ? J(i, h) : p[u]) > -1 && (i[c] = !(o[c] = h))
                    }
                } else w = g(w === o ? w.splice(m, w.length) : w), s ? s(null, o, w, l) : G.apply(o, w)
            })
        }

        function v(e) {
            for (var t, n, i, r = e.length, s = b.relative[e[0].type], o = s || b.relative[" "], a = s ? 1 : 0, l = p(function (e) {
                    return e === t
                }, o, !0), c = p(function (e) {
                    return J(t, e) > -1
                }, o, !0), u = [function (e, n, i) {
                    var r = !s && (i || n !== k) || ((t = n).nodeType ? l(e, n, i) : c(e, n, i));
                    return t = null, r
                }]; a < r; a++)
                if (n = b.relative[e[a].type]) u = [p(d(u), n)];
                else {
                    if (n = b.filter[e[a].type].apply(null, e[a].matches), n[z]) {
                        for (i = ++a; i < r && !b.relative[e[i].type]; i++);
                        return m(a > 1 && d(u), a > 1 && h(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(se, "$1"), n, a < i && v(e.slice(a, i)), i < r && v(e = e.slice(i)), i < r && h(e))
                    }
                    u.push(n)
                } return d(u)
        }
            ...
            var r = n.length > 0,
                ...
                o = function (i, o, a, l, c) {
                    var u, h, p, d = 0,
                        ...
                        _ = w.length;
                    for (c && (k = o === N || o || c); f !== _ && null != (u = w[f]); f++) {
                        if (s && u) {
                            for (h = 0, o || u.ownerDocument === N || (A(u), a = !L); p = e[h++];)
                                if (p(u, o || N, a)) {
                                    l.push(u);
                                    break
                                } c && (R = x)
        ...
        var w, x, b, _, C, T, E, S, k, D, j, A, N, $, L, q, H, O, P, z = "sizzle" + 1 * new Date,
            F = e.document,
            R = 0,
            M = 0,
            I = n(),
        ...
        try {
            G.apply(V = Z.call(F.childNodes), F.childNodes), V[F.childNodes.length].nodeType
        } catch (e) {
            G = {
        ...
        x = t.support = {}, C = t.isXML = function (e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, $ = N.documentElement, L = !C(N), F !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)), x.attributes = r(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = r(function (e) {
                return e.appendChild(N.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = fe.test(N.getElementsByClassName), x.getById = r(function (e) {
            ...
            }, H = [], q = [], (x.qsa = fe.test(N.querySelectorAll)) && (r(function (e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && q.push("name" + ee + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && q.push(":enabled", ":disabled"), $.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && q.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), q.push(",.*:")
            })), (x.matchesSelector = fe.test(O = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && r(function (e) {
                x.disconnectedMatch = O.call(e, "*"), O.call(e, "[s!='']:x"), H.push("!=", ie)
            }), q = q.length && new RegExp(q.join("|")), H = H.length && new RegExp(H.join("|")), t = fe.test($.compareDocumentPosition), P = t || fe.test($.contains) ? function (e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === F && P(F, e) ? -1 : t === N || t.ownerDocument === F && P(F, t) ? 1 : D ? J(D, e) - J(D, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return j = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!r || !s) return e === N ? -1 : t === N ? 1 : r ? -1 : s ? 1 : D ? J(D, e) - J(D, t) : 0;
                if (r === s) return o(e, t);
            ...
            if ((e.ownerDocument || e) !== N && A(e), n = n.replace(le, "='$1']"), x.matchesSelector && L && !B[n + " "] && (!H || !H.test(n)) && (!q || !q.test(n))) try {
                var i = O.call(e, n);
            ...
            var n = b.attrHandle[t.toLowerCase()],
                i = n && X.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (j = !x.detectDuplicates, D = !x.sortStable && e.slice(0), e.sort(U), j) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (f = [o ? m.firstChild : m.lastChild], o && y) {
                                for (p = m, h = p[z] || (p[z] = {}), u = h[p.uniqueID] || (h[p.uniqueID] = {}), c = u[e] || [], d = c[0] === R && c[1], w = d && c[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (w = d = 0) || f.pop();)
                                    if (1 === p.nodeType && ++w && p === t) {
                                        u[e] = [R, d, w];
                                        break
                                    }
                            } else if (y && (p = t, h = p[z] || (p[z] = {}), u = h[p.uniqueID] || (h[p.uniqueID] = {}), c = u[e] || [], d = c[0] === R && c[1], w = d), !1 === w)
                                for (;
                                    (p = ++d && p && p[g] || (w = d = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++w || (y && (h = p[z] || (p[z] = {}), u = h[p.uniqueID] || (h[p.uniqueID] = {}), u[e] = [R, w]), p !== t)););
                ...
                PSEUDO: function (e, n) {
                    ...
                    return s[z] ? s(n) : s.length > 1 ? (r = [e, e, "", n], b.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
                        for (var i, r = s(e, n), o = r.length; o--;) i = J(e, r[o]), e[i] = !(t[i] = r[o])
                    }) : function (e) {
                        return s(e, 0, r)
                    }) : s
                }
        ...
        return u.prototype = b.filters = b.pseudos, b.setFilters = new u, T = t.tokenize = function (e, n) {
            ...
            for (a = e, l = [], c = b.preFilter; a;) {
                ...
                for (o in b.filter) !(r = he[o].exec(a)) || c[o] && !(r = c[o](r)) || (i = r.shift(), s.push({
                    value: i,
                    type: o,
                    matches: r
                }), a = a.slice(i.length));
            ...
            var n, i = [],
                ...
                s = B[e + " "];
            if (!s) {
                for (t || (t = T(e)), n = t.length; n--;) s = v(t[n]), s[z] ? i.push(s) : r.push(s);
                s = B(e, y(r, i)), s.selector = e
            }
            return s
            ...
            if (n = n || [], 1 === p.length) {
                if (s = p[0] = p[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && 9 === t.nodeType && L && b.relative[s[1].type]) {
                    if (!(t = (b.find.ID(o.matches[0].replace(ve, ye), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(s.shift().value.length)
                }
                for (r = he.needsContext.test(e) ? 0 : s.length; r-- && (o = s[r], !b.relative[a = o.type]);)
                    if ((l = b.find[a]) && (i = l(o.matches[0].replace(ve, ye), me.test(s[0].type) && c(t.parentNode) || t))) {
                        if (s.splice(r, 1), !(e = i.length && h(s))) return G.apply(n, i), n;
                        break
                    }
            }
            return (u || E(e, p))(i, t, !L, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, x.sortStable = z.split("").sort(U).join("") === z, x.detectDuplicates = !!j, A(), x.sortDetached = r(function (e) {
    ...
    fe.filter = function (e, t, n) {
        ...
        is: function (e) {
            return !!s(this, "string" == typeof e && _e.test(e) ? fe(e) : e || [], !1).length
        }
    });
    var Ee, Se = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (fe.fn.init = function (e, t, n) {
        ...
        if (n = n || Ee, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof fe ? t[0] : t, fe.merge(this, fe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), Ce.test(i[1]) && fe.isPlainObject(t))
    ...
    fe.fn.extend({
        ...
        fe.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = fe.filter(i, r)), this.length > 1 && (De[e] || fe.uniqueSort(r), ke.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var je = /[^\x20\t\r\n\f]+/g;
    fe.Callbacks = function (e) {
        ...
        var t, n, i, r, s = [],
            ...
            c = function () {
                for (r = r || e.once, i = t = !0; o.length; l = -1)
                    for (n = o.shift(); ++l < s.length;) !1 === s[l].apply(n[0], n[1]) && e.stopOnFalse && (l = s.length, n = !1);
                ...
                r = {
                    ...
                    then: function (t, i, r) {
                                ...
                                var a = this,
                                    ...
                                    h = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            h = e && ("object" == typeof e || "function" == typeof e) && e.then, fe.isFunction(h) ? r ? h.call(e, s(o, n, l, r), s(o, n, c, r)) : (o++, h.call(e, s(o, n, l, r), s(o, n, c, r), s(o, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [e]), (r || n.resolveWith)(a, u))
                                        }
                                    },
                                    p = r ? h : function () {
                                        try {
                                            ...
                                            fe.Deferred.exceptionHook && fe.Deferred.exceptionHook(e, p.stackTrace), t + 1 >= o && (i !== c && (a = void 0, u = [e]), n.rejectWith(a, u))
                                        }
                                    };
                        ...
                        return fe.Deferred(function (e) {
                            n[0][3].add(s(0, e, fe.isFunction(r) ? r : l, e.notifyWith)), n[1][3].add(s(0, e, fe.isFunction(t) ? t : l)), n[2][3].add(s(0, e, fe.isFunction(i) ? i : c))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            var t = arguments.length,
                ...
                o = function (e) {
                    return function (n) {
                        i[e] = this, r[e] = arguments.length > 1 ? re.call(arguments) : n, --t || s.resolveWith(i, r)
                    }
                };
            if (t <= 1 && (u(e, s.done(o(n)).resolve, s.reject, !t), "pending" === s.state() || fe.isFunction(r[n] && r[n].then))) return s.then();
    ...
    fe.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --fe.readyWait : fe.isReady) || (fe.isReady = !0, !0 !== e && --fe.readyWait > 0 || Ne.resolveWith(ne, [fe]))
        }
    }), fe.ready.then = Ne.then, "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(fe.ready) : (ne.addEventListener("DOMContentLoaded", h), e.addEventListener("load", h));
    var $e = function (e, t, n, i, r, s, o) {
            var a = 0,
                l = e.length,
                c = null == n;
            if ("object" === fe.type(n)) {
                r = !0;
                for (a in n) $e(e, t, a, n[a], !0, s, o)
            } else if (void 0 !== i && (r = !0, fe.isFunction(i) || (o = !0), c && (o ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
    ...
    p.uid = 1, p.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    Array.isArray(t) ? t = t.map(fe.camelCase) : (t = fe.camelCase(t), t = t in i ? [t] : t.match(je) || []), n = t.length;
                    for (; n--;) delete i[t[n]]
    ...
    fe.extend({
        ...
        data: function (e, t) {
            var n, i, r, s = this[0],
                o = s && s.attributes;
            if (void 0 === e) {
                if (this.length && (r = He.get(s), 1 === s.nodeType && !qe.get(s, "hasDataAttrs"))) {
                    for (n = o.length; n--;) o[n] && (i = o[n].name, 0 === i.indexOf("data-") && (i = fe.camelCase(i.slice(5)), f(s, i, r[i])));
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n;
                if (s && void 0 === t) {
                    if (void 0 !== (n = He.get(s, e))) return n;
        ...
        queue: function (e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = qe.get(e, t), n && (!i || Array.isArray(n) ? i = qe.access(e, t, fe.makeArray(n)) : i.push(n)), i || []
        },
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; o--;)(n = qe.get(s[o], e + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    fe.event = {
        ...
        add: function (e, t, n, i, r) {
            var s, o, a, l, c, u, h, p, d, f, g, m = qe.get(e);
            if (m)
                for (n.handler && (s = n, n = s.handler, r = s.selector), r && fe.find.matchesSelector(Ye, r), n.guid || (n.guid = fe.guid++), (l = m.events) || (l = m.events = {}), (o = m.handle) || (o = m.handle = function (t) {
                        return void 0 !== fe && fe.event.triggered !== t.type ? fe.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(je) || [""], c = t.length; c--;) a = Je.exec(t[c]) || [], d = g = a[1], f = (a[2] || "").split(".").sort(), d && (h = fe.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = fe.event.special[d] || {}, u = fe.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, s), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, f, o) || e.addEventListener && e.addEventListener(d, o)), h.add && (h.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), fe.event.global[d] = !0)
        },
        remove: function (e, t, n, i, r) {
            var s, o, a, l, c, u, h, p, d, f, g, m = qe.hasData(e) && qe.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(je) || [""], c = t.length; c--;)
                    if (a = Je.exec(t[c]) || [], d = g = a[1], f = (a[2] || "").split(".").sort(), d) {
                        for (h = fe.event.special[d] || {}, d = (i ? h.delegateType : h.bindType) || d, p = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = p.length; s--;) u = p[s], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(s, 1), u.selector && p.delegateCount--, h.remove && h.remove.call(e, u));
                        o && !p.length && (h.teardown && !1 !== h.teardown.call(e, f, m.handle) || fe.removeEvent(e, d, m.handle), delete l[d])
                    } else
                        for (d in l) fe.event.remove(e, d + t[c], n, i, !0);
                fe.isEmptyObject(l) && qe.remove(e, "handle events")
            }
        },
        dispatch: function (e) {
            var t, n, i, r, s, o, a = fe.event.fix(e),
                l = new Array(arguments.length),
                c = (qe.get(this, "events") || {})[a.type] || [],
                u = fe.event.special[a.type] || {};
            for (l[0] = a, t = 1; t < arguments.length; t++) l[t] = arguments[t];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (o = fe.event.handlers.call(this, a, c), t = 0;
                    (r = o[t++]) && !a.isPropagationStopped();)
                    for (a.currentTarget = r.elem, n = 0;
                        (s = r.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(s.namespace) || (a.handleObj = s, a.data = s.data, void 0 !== (i = ((fe.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (s = [], o = {}, n = 0; n < l; n++) i = t[n], r = i.selector + " ", void 0 === o[r] && (o[r] = i.needsContext ? fe(r, this).index(c) > -1 : fe.find(r, this, null, [c]).length), o[r] && s.push(i);
                        s.length && a.push({
                            elem: c,
                            handlers: s
                        })
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? b : _, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && fe.extend(this, t), this.timeStamp = e && e.timeStamp || fe.now(), this[fe.expando] = !0
    }, fe.Event.prototype = {
    ...
    fe.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || fe.isXMLDoc(e)))
                for (o = y(a), s = y(e), i = 0, r = s.length; i < r; i++) j(s[i], o[i]);
            if (t)
                if (n)
                    for (s = s || y(e), o = o || y(a), i = 0, r = s.length; i < r; i++) D(s[i], o[i]);
                else D(e, a);
            return o = y(a, "script"), o.length > 0 && w(o, !l && y(e, "script")), a
        },
        ...
        fe.fn[e] = function (e) {
            for (var n, i = [], r = fe(e), s = r.length - 1, o = 0; o <= s; o++) n = o === s ? this : this.clone(!0), fe(r[o])[t](n), oe.apply(i, n.get());
    ...
    ! function () {
        function t() {
            if (a) {
                a.style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", a.innerHTML = "", Ye.appendChild(o);
                var t = e.getComputedStyle(a);
                n = "1%" !== t.top, s = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, Ye.removeChild(o), a = null
            }
        }
        var n, i, r, s, o = ne.createElement("div"),
            a = ne.createElement("div");
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", de.clearCloneStyle = "content-box" === a.style.backgroundClip, o.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", o.appendChild(a), fe.extend(de, {
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, s, o, a = fe.camelCase(t),
                    l = lt.test(t),
                    c = e.style;
                if (l || (t = H(a)), o = fe.cssHooks[t] || fe.cssHooks[a], void 0 === n) return o && "get" in o && void 0 !== (r = o.get(e, !1, i)) ? r : c[t];
                s = typeof n, "string" === s && (r = Fe.exec(n)) && r[1] && (n = g(e, t, r), s = "number"), null != n && n === n && ("number" === s && (n += r && r[3] || (fe.cssNumber[a] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), o && "set" in o && void 0 === (n = o.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var r, s, o, a = fe.camelCase(t);
            return lt.test(t) || (t = H(a)), o = fe.cssHooks[t] || fe.cssHooks[a], o && "get" in o && (r = o.get(e, !0, n)), void 0 === r && (r = $(e, t, i)), "normal" === r && t in ut && (r = ut[t]), "" === n || n ? (s = parseFloat(r), !0 === n || isFinite(s) ? s || 0 : r) : r
        }
    }), fe.each(["height", "width"], function (e, t) {
        fe.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !at.test(fe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? z(e, t, i) : Ie(e, ct, function () {
                    return z(e, t, i)
                })
            },
            set: function (e, n, i) {
                var r, s = i && ot(e),
                    o = i && P(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, s), s);
                return o && (r = Fe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = fe.css(e, t)), O(e, n, o)
            }
        }
    }), fe.cssHooks.marginLeft = L(de.reliableMarginLeft, function (e, t) {
        if (t) return (parseFloat($(e, "marginLeft")) || e.getBoundingClientRect().left - Ie(e, {
            marginLeft: 0
        }, function () {
        ...
        css: function (e, t) {
            return $e(this, function (e, t, n) {
                var i, r, s = {},
                    o = 0;
                if (Array.isArray(t)) {
                    for (i = ot(e), r = t.length; o < r; o++) s[t[o]] = fe.css(e, t[o], !1, i);
                    return s
                }
    ...
    fe.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== s && 8 !== s && 2 !== s) return void 0 === e.getAttribute ? fe.prop(e, t, n) : (1 === s && fe.isXMLDoc(e) || (r = fe.attrHooks[t.toLowerCase()] || (fe.expr.match.bool.test(t) ? vt : void 0)), void 0 !== n ? null === n ? void fe.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = fe.find.attr(e, t), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        yt[t] = function (e, t, i) {
            ...
            return i || (s = yt[o], yt[o] = r, r = null != n(e, t, i) ? o : null, yt[o] = s), r
        }
    });
    ...
    fe.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : fe.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, s;
                if ("string" === n)
                    for (i = 0, r = fe(this), s = e.match(je) || []; t = s[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
        ...
        val: function (e) {
            var t, n, i, r = this[0]; {
                if (arguments.length) return i = fe.isFunction(e), this.each(function (n) {
                    var r;
                    1 === this.nodeType && (r = i ? e.call(this, n, fe(this).val()) : e, null == r ? r = "" : "number" == typeof r ? r += "" : Array.isArray(r) && (r = fe.map(r, function (e) {
                        return null == e ? "" : e + ""
                    })), (t = fe.valHooks[this.type] || fe.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, r, "value") || (this.value = r))
                });
                if (r) return (t = fe.valHooks[r.type] || fe.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(bt, "") : null == n ? "" : n)
            }
        }
    }), fe.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function (e, t) {
                    for (var n, i, r = e.options, s = fe.makeArray(t), o = r.length; o--;) i = r[o], (i.selected = fe.inArray(fe.valHooks.option.get(i), s) > -1) && (n = !0);
    ...
    fe.extend(fe.event, {
        trigger: function (t, n, i, r) {
            var s, o, a, l, c, u, h, p = [i || ne],
                d = ue.call(t, "type") ? t.type : t,
                f = ue.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = a = i = i || ne, 3 !== i.nodeType && 8 !== i.nodeType && !_t.test(d + fe.event.triggered) && (d.indexOf(".") > -1 && (f = d.split("."), d = f.shift(), f.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[fe.expando] ? t : new fe.Event(d, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : fe.makeArray(n, [t]), h = fe.event.special[d] || {}, r || !h.trigger || !1 !== h.trigger.apply(i, n))) {
                if (!r && !h.noBubble && !fe.isWindow(i)) {
                    for (l = h.delegateType || d, _t.test(l + d) || (o = o.parentNode); o; o = o.parentNode) p.push(o), a = o;
                    a === (i.ownerDocument || ne) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (s = 0;
                    (o = p[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : h.bindType || d, u = (qe.get(o, "events") || {})[t.type] && qe.get(o, "handle"), u && u.apply(o, n), (u = c && o[c]) && u.apply && Le(o) && (t.result = u.apply(o, n), !1 === t.result && t.preventDefault());
                return t.type = d, r || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(p.pop(), n) || !Le(i) || c && fe.isFunction(i[d]) && !fe.isWindow(i) && (a = i[c], a && (i[c] = null), fe.event.triggered = d, i[d](), fe.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    fe.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !fe(this).is(":disabled") && jt.test(this.nodeName) && !Dt.test(e) && (this.checked || !Be.test(e))
            }).map(function (e, t) {
                var n = fe(this).val();
    ...
    Rt.href = Ct.href, fe.extend({
        ...
        ajax: function (t, n) {
            function i(t, n, i, a) {
                var c, p, d, x, b, _ = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, o = a || "", C.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (x = K(f, C, i)), x = ee(f, x, C, c), c ? (f.ifModified && (b = C.getResponseHeader("Last-Modified"), b && (fe.lastModified[s] = b), (b = C.getResponseHeader("etag")) && (fe.etag[s] = b)), 204 === t || "HEAD" === f.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = x.state, p = x.data, d = x.error, c = !d)) : (d = _, !t && _ || (_ = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || _) + "", c ? v.resolveWith(g, [p, _, C]) : v.rejectWith(g, [C, _, d]), C.statusCode(w), w = void 0, h && m.trigger(c ? "ajaxSuccess" : "ajaxError", [C, f, c ? p : d]), y.fireWith(g, [C, _]), h && (m.trigger("ajaxComplete", [C, f]), --fe.active || fe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, s, o, a, l, c, u, h, p, d, f = fe.ajaxSetup({}, n),
                g = f.context || f,
            ...
            if (v.promise(C), f.url = ((t || f.url || Ct.href) + "").replace(Ot, Ct.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(je) || [""], null == f.crossDomain) {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = fe.param(f.data, f.traditional)), Z(Pt, f, n, C), u) return C;
            h = fe.event && f.global, h && 0 == fe.active++ && fe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Ht.test(f.type), s = f.url.replace(Nt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(At, "+")) : (d = f.url.slice(s.length), f.data && (s += (Et.test(s) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (s = s.replace($t, "$1"), d = (Et.test(s) ? "&" : "?") + "_=" + Tt++ + d), f.url = s + d), f.ifModified && (fe.lastModified[s] && C.setRequestHeader("If-Modified-Since", fe.lastModified[s]), fe.etag[s] && C.setRequestHeader("If-None-Match", fe.etag[s])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : f.accepts["*"]);
            for (p in f.headers) C.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(g, C, f) || u)) return C.abort();
            if (_ = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), r = Z(zt, f, n, C)) {
    ...
    de.cors = !!It && "withCredentials" in It, de.ajax = It = !!It, fe.ajaxTransport(function (t) {
        var n, i;
        if (de.cors || It && !t.crossDomain) return {
            send: function (r, s) {
                var o, a = t.xhr();
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Mt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    fe.ajaxSetup({
        ...
        var r, s, o, a = !1 !== t.jsonp && (Bt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Bt.test(t.data) && "data");
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = fe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Bt, "$1" + r) : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return o || fe.error(r + " was not called"), o[0]
        }, t.dataTypes[0] = "json", s = e[r], e[r] = function () {
            o = arguments
        }, i.always(function () {
            void 0 === s ? fe(e).removeProp(r) : e[r] = s, t[r] && (t.jsonpCallback = n.jsonpCallback, Wt.push(r)), o && fe.isFunction(s) && s(o[0]), o = s = void 0
        }), "script"
        ...
        var i, r, s;
        return t || (de.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ne.location.href, t.head.appendChild(i)) : t = ne), r = Ce.exec(e), s = !n && [], r ? [t.createElement(r[1])] : (r = x([e], t, s), s && s.length && fe(s).remove(), fe.merge([], r.childNodes))
    }, fe.fn.load = function (e, t, n) {
        var i, r, s, o = this,
            a = e.indexOf(" ");
        return a > -1 && (i = V(e.slice(a)), e = e.slice(0, a)), fe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), o.length > 0 && fe.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, r, s, o, a, l, c, u = fe.css(e, "position"),
                h = fe(e),
                p = {};
            "static" === u && (e.style.position = "relative"), a = h.offset(), s = fe.css(e, "top"), l = fe.css(e, "left"), c = ("absolute" === u || "fixed" === u) && (s + l).indexOf("auto") > -1, c ? (i = h.position(), o = i.top, r = i.left) : (o = parseFloat(s) || 0, r = parseFloat(l) || 0), fe.isFunction(t) && (t = t.call(e, n, fe.extend({}, a))), null != t.top && (p.top = t.top - a.top + o), null != t.left && (p.left = t.left - a.left + r), "using" in t ? t.using.call(e, p) : h.css(p)
        }
    }, fe.fn.extend({
        offset: function (e) {
            ...
            if (s) return s.getClientRects().length ? (i = s.getBoundingClientRect(), t = s.ownerDocument, n = t.documentElement, r = t.defaultView, {
        ...
        fe.fn[e] = function (i) {
            return $e(this, function (e, i, r) {
                var s;
                if (fe.isWindow(e) ? s = e : 9 === e.nodeType && (s = e.defaultView), void 0 === r) return s ? s[t] : e[i];
                s ? s.scrollTo(n ? s.pageXOffset : r, n ? r : s.pageYOffset) : e[i] = r
            }, e, i, arguments.length)
        }
    }), fe.each(["top", "left"], function (e, t) {
        fe.cssHooks[t] = L(de.pixelPosition, function (e, n) {
            if (n) return n = $(e, t), st.test(n) ? fe(e).position()[t] + "px" : n
        })
    }), fe.each({
        Height: "height",
        Width: "width"
        ...
        fe.each({
            ...
            fe.fn[i] = function (r, s) {
                ...
                return $e(this, function (t, n, r) {
                    var s;
                    return fe.isWindow(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (s = t.documentElement, Math.max(t.body["scroll" + e], s["scroll" + e], t.body["offset" + e], s["offset" + e], s["client" + e])) : void 0 === r ? fe.css(t, n, a) : fe.style(t, n, r, a)
                }, t, o ? r : void 0, o)
            }
        })
    }), fe.fn.extend({
    ...
    return fe.noConflict = function (t) {
        return e.$ === fe && (e.$ = Xt), t && e.jQuery === fe && (e.jQuery = Ut), fe
    }, t || (e.jQuery = e.$ = fe), fe
}),
function (e, t, n, i) {
    function r(t, n) {
    ...
    r.Defaults = {
        ...
        return this.settings.freeDrag || e.each(s, e.proxy(function (e, o) {
            return "left" === n && t > o - 30 && t < o + 30 ? i = e : "right" === n && t > o - r - 30 && t < o - r + 30 ? i = e + 1 : this.op(t, "<", o) && this.op(t, ">", s[e + 1] || o - r) && (i = "left" === n ? e + 1 : e), -1 === i
        ...
        var n = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(r) > o / 2 && (r += -1 * s * o), e = n + r, (i = ((e - a) % o + o) % o + a) !== e && i - r <= l && i - r > 0 && (n = i - r, e = i, this.reset(n))) : this.settings.rewind ? (l += 1, e = (e % l + l) % l) : e = Math.max(a, Math.min(l, e)), this.speed(this.duration(n, e, t)), this.current(e), this.$element.is(":visible") && this.update()
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": e.proxy(function (t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var n = this._core.settings, i = n.center && Math.ceil(n.items / 2) || n.items, r = n.center && -1 * i || 0, s = (t.property && void 0 !== t.property.value ? t.property.value : this._core.current()) + r, o = this._core.clones().length, a = e.proxy(function (e, t) {
                            this.load(t)
...
function (e, t, n, i) {
    ...
    r.Defaults = {
        ...
        if (t.wrap('<div class="owl-video-wrapper"' + o + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length) return h(a.attr(l)), a.remove(), !1;
...
function () {
    ...
    var e = {
        ...
        r = function (e) {
            return t.width() >= i(e).min
        },
        s = function (e, t, n, i) {
            function r() {
                function r() {
                    o = Number(new Date), n.apply(l, u)
                }
                ...
                var l = this,
                    c = Number(new Date) - o,
                    u = arguments;
                i && !s && r(), s && clearTimeout(s), void 0 === i && c > e ? r() : !0 !== t && (s = setTimeout(i ? a : r, void 0 === i ? e - c : e))
            }
            var s, o = 0;
            return "boolean" != typeof t && (i = n, n = t, t = void 0), r
        },
        o = function (e, t, n) {
            return void 0 === n ? s(e, t, !1) : s(e, n, !1 !== t)
        },
        a = function (e, t) {
        ...
        c = function () {
            function e(t, n, i) {
                a(this, e), this.headerSelector = t || ".main-header-js", this.sectionSelector = n || ".main-wrapper > .section", this.offsetHeight = i || -10
            }
            return l(e, [{
                key: "headerHandling",
                value: function () {
                    var e = this.sectionElem.offsetHeight + this.offsetHeight;
                    window.pageYOffset >= e / 2.5 ? (this.headerElem.classList.contains("main-header-fixed") || this.headerElem.classList.add("main-header-fixed"), window.pageYOffset >= e ? this.show() : window.pageYOffset < e && this.hide()) : (this.headerElem.classList.contains("main-header-fixed") && this.headerElem.classList.remove("main-header-fixed"), this.headerElem.classList.contains("show") && this.headerElem.classList.remove("show"), this.headerElem.classList.contains("hide") && this.headerElem.classList.remove("hide"))
                }
            }, {
                key: "show",
                value: function () {
                    this.isVisible || (this.headerElem.classList.remove("hide"), this.headerElem.classList.add("show"), this.isVisible = !0)
                }
            }, {
                key: "hide",
                value: function () {
                    this.isVisible && (this.headerElem.classList.remove("show"), this.headerElem.classList.add("hide"), this.isVisible = !1)
                }
            }, {
                key: "init",
                value: function () {
                    if (!this.headerElem) {
                        this.headerElem = document.querySelector(this.headerSelector), this.sectionElem = document.querySelector(this.sectionSelector)
                    }
                }
            }]), e
        }(),
        u = function () {
            function e(t, n) {
                a(this, e), this.navSelector = t || ".side-nav-js", this.navToggleSelector = n || '*[class$="nav-toggle-js"]', this.isOpen = !1
            }
            return l(e, [{
                key: "open",
                value: function () {
                    this.navElem.classList.add("open"), this.isOpen = !0
                }
            }, {
                key: "close",
                value: function () {
                    this.navElem.classList.remove("open"), this.isOpen = !1
                }
            }, {
                key: "toggle",
                value: function () {
                    if (!this.isOpen) return void this.open();
                    this.close()
                }
            }, {
                key: "init",
                value: function () {
                    var e = this;
                    if (!this.navElem) {
                        var n = this.navElem = document.querySelector(this.navSelector),
                            i = this.navToggleElem = [].slice.call(document.querySelectorAll(this.navToggleSelector));
                        n && i && (i.forEach(function (t) {
                            t.addEventListener("click", function (t) {
                                t.stopPropagation(), e.toggle()
                            })
                        }), t.on("click", function (t) {
                            !$(t.target).parents(e.navSelector).length && e.isOpen && e.close()
                        }))
                    }
                }
            }]), e
        ...
        h = function () {
            function e(t, n) {
                a(this, e), this.scrollSelector = t || 'a[href*="#"]', this.callback = n || null
            }
            return l(e, [{
                key: "setCallback",
                value: function (e) {
                ...
                value: function () {
                    var e = this;
                    if (!this.scrollElems) {
                        (this.scrollElems = $(this.scrollSelector).not('[href="#"]')).click(function (t) {
                            var n = $(t.currentTarget.hash);
                            n.length && (t.preventDefault(), $("html, body").animate({
                                scrollTop: n.offset().top
                            }, 800).promise().then(e.callback))
                        })
                    }
                }
            }]), e
        ...
        p = function () {
            function e(t, n, i) {
                a(this, e), this.scrollSelector = t || 'a[data-spy][href*="#"]', this.scrollActiveClass = n || "active", this.offsetHeight = i || -65, this.scrollRanges = [], this.currRangeIndex = 0
            }
            return l(e, [{
                key: "refresh",
                value: function () {
                    for (var e = document.documentElement.scrollTop || document.body.scrollTop, t = 0; t < this.scrollRanges.length; t++) {
                        var n = this.scrollRanges[t].rangeElem;
                        if (!n) return;
                        var i = n.offsetTop + this.offsetHeight,
                            r = n.offsetHeight + n.offsetTop - 10;
                        if (e >= i && e < r) return void this.setCurrRange(t)
                    }
                }
            }, {
                key: "setCurrRange",
                value: function (e) {
                    var t = this;
                    this.currRangeIndex !== e && (this.scrollRanges[this.currRangeIndex].elems.forEach(function (e) {
                        e.classList.remove(t.scrollActiveClass)
                    }), this.currRangeIndex = e, this.scrollRanges[this.currRangeIndex].elems.forEach(function (e) {
                        e.classList.add(t.scrollActiveClass)
                    }))
                }
            }, {
                key: "init",
                value: function () {
                    var e = this;
                    if (!this.scrollElems) {
                        var t = this.scrollElems = [].slice.call(document.querySelectorAll(this.scrollSelector));
                        if (t) {
                            var n = [];
                            t.forEach(function (t) {
                                var i = t.hash,
                                    r = n.indexOf(i); - 1 === r ? (n.push(i), e.scrollRanges.push({
                                    elems: [t],
                                    rangeElem: document.querySelector(i)
                                })) : e.scrollRanges[r].elems.push(t)
                            }), this.refresh()
                        }
                    }
                }
        ...
        d = function () {
            function e(t) {
                a(this, e), this.modalSelector = t || ".modal-js"
            }
            return l(e, [{
                key: "open",
                value: function (e) {
                    var t = this;
                    this.modalElem.classList.add("open"), setTimeout(function () {
                        t.modalElem.focus()
                ...
                value: function () {
                    if (!this.modalElem) {
                        this.modalElem = document.querySelector(this.modalSelector)
                    }
                }
            }]), e
        }(),
        f = function () {
            function e(t) {
                a(this, e), this.owlCaruselSelector = t || ".owl-carousel-services-js"
            }
            return l(e, [{
                key: "init",
                value: function () {
                    if (!this.owlCaruselElem) {
                        var e = this.owlCaruselElem = $(".owl-carousel-services-js");
                        e.owlCarousel({
                            loop: !0,
                            center: !0,
                            autoplay: !0,
                        ...
                        var t = new d(".services-info-js");
                        t.init(), e.on("click", "button.services-item-button-js", function () {
                            t.open()
                        })
                    }
                }
        ...
        g = function () {
            function e(t, n, i, r, s) {
                a(this, e), this.filtersSelector = t || ".portfolio-filters-js", this.itemsSelector = n || ".portfolio-items-js", this.filterActiveClass = i || "active", this.itemShowClass = r || "show", this.itemHideClass = s || "hide", this.filters = document.querySelector(this.filtersSelector), this.currFilter = document.querySelector(this.filtersSelector + " button[data-filter-type]." + this.filterActiveClass), this.items = [].slice.call(document.querySelectorAll(this.itemsSelector + " div[data-type]")), this.currItems = []
            }
            return l(e, [{
                key: "getEventFilter",
                value: function (e) {
                    return e.hasAttribute("data-filter-type") ? e : e.parentNode.hasAttribute("data-filter-type") ? e.parentNode : null
                }
            }, {
                key: "setCurrFilter",
                value: function (e) {
                    null !== this.currFilter && this.currFilter.classList.remove(this.filterActiveClass), this.currFilter = e, this.currFilter.classList.add(this.filterActiveClass)
                }
            }, {
                key: "filterBy",
                value: function (e, t) {
                    var n = this;
                    if (null !== e && e !== this.currFilter || t) {
                        var i = "",
                            r = 0;
                        void 0 !== e && (this.setCurrFilter(e), i = e.getAttribute("data-filter-type")), this.currItems = this.items.filter(function (e) {
                            var t = i === e.getAttribute("data-type") || "" === i;
                            return t ? (e.classList.remove(n.itemHideClass), e.classList.add(n.itemShowClass), n.addStyles(e, r), r++) : (e.classList.remove(n.itemShowClass), e.classList.add(n.itemHideClass)), t
                        })
                    }
                }
            }, {
                ...
                value: function () {
                    var e = this,
                        ...
                        n = this.items,
                        i = this.currFilter;
                    t && n && (this.filterBy(i || void 0, !0), t.addEventListener("click", function (t) {
                        var n = e.getEventFilter(t.target);
                        n && e.filterBy(n)
                    }))
                }
            }]), e
        ...
        m = function () {
            function e(t, n, i, r, s, o) {
                a(this, e), this.formSelector = t || ".contact-form-js", this.defaultUrl = n || "/endpoints/contact-form", this.defaultMethod = i || "POST", this.reqTimeout = r || 2500, this.formSuccessSelector = s || ".contact-form-success-js", this.formErrorSelector = o || ".contact-form-error-js"
            }
            return l(e, [{
                key: "createModal",
                value: function (e) {
                ...
                key: "getFormUrl",
                value: function () {
                    var e = this.formElem.getAttribute("action");
                    return "#" !== e && e ? e : this.defaultUrl
                }
            }, {
                key: "getFormMethod",
                value: function () {
                    var e = this.formElem.getAttribute("method");
                    return e ? e.toUpperCase() : this.defaultMethod
                }
            }, {
                key: "getFormData",
                value: function () {
                    var e = {};
                    return this.inputElems.forEach(function (t) {
                ...
                key: "cleanForm",
                value: function () {
                    this.inputElems.forEach(function (e) {
                        e.value = ""
                    })
                }
            }, {
                ...
                value: function () {
                    var e = this;
                    if (!this.formElem) {
                        var t = this.formElem = document.querySelector(this.formSelector),
                            n = this.inputElems = [].slice.call(document.querySelectorAll(this.formSelector + " input, " + this.formSelector + " textarea"));
                        if (t && n) {
                            var i = this.formSuccess = this.createModal(this.formSuccessSelector),
                                r = this.formError = this.createModal(this.formErrorSelector);
                            t.addEventListener("submit", function (n) {
                                n.preventDefault(), t.checkValidity() && (t.classList.add("contact-form-loading"), setTimeout(function () {
                                    $.ajax({
                                        url: e.getFormUrl(),
                                        method: e.getFormMethod(),
                                        data: e.getFormData()
                                    }).then(function () {
                                        i.open(), e.cleanForm()
                                    }, function () {
                                        ...
                                        t.classList.remove("contact-form-loading")
                                    })
                                }, e.reqTimeout))
                            })
                        }
        ...
        v = function () {
            function e(t) {
                a(this, e), t = t || {}, this.gUser = t.gUser || "mateuszarchicinski", this.gUrl = t.gUrl || "https://github.com", this.gApiUrl = t.gApiUrl || "https://api.github.com", this.gReqTypes = t.reqTypes || {
                    starred: {
                        name: "Starred",
                ...
                }, this.timeInterval = t.timeInterval || 12e4
            }
            return l(e, [{
                key: "createURI",
                value: function (e) {
                    if (e) {
                        var t = this.gApiUrl + e.url;
                        return e.limit && (t += "?per_page=" + e.limit), t
                    }
                }
            }, {
                key: "getResources",
                ...
                value: function (e) {
                    ...
                    if (e) {
                        ...
                        return e.forEach(function (e) {
                            var i = {},
                                r = [];
                            if (e.stargazers_count && (r.push({
                                    type: "golden",
                                    iconAriaLabel: "Number of assigned stars:",
                                    iconName: "star",
                                    text: e.stargazers_count
                                }), i.href = e.html_url, i.text = e.full_name), e.type) {
                                var s = e.repo.name,
                                    o = new Date(e.created_at).toLocaleString().split(/(,| )/)[0];
                                if (r.push({
                                        type: "primary",
                                        iconName: "ok"
                                    }), r.push({
                                        ...
                                        iconName: "clock",
                                        text: o
                                    }), -1 !== ["CreateEvent", "WatchEvent", "PushEvent"].indexOf(e.type) && (i.href = t.gUrl + "/" + s), "CreateEvent" === e.type && (i.text = "Created a new repository " + s, "tag" === e.payload.ref_type && (r.push({
                                        type: "accent-light",
                                        iconName: "tag",
                                        text: e.payload.ref
                                    }), i.href += "/releases/tag/" + e.payload.ref, i.text = "Tagged " + e.payload.ref + " repository " + s)), "WatchEvent" === e.type && (r.push({
                                        type: "accent-light",
                                        iconName: "eye"
                                    }), i.text = "Began watching " + s), "PushEvent" === e.type) {
                                    var a = e.payload.commits.length;
                                    r.push({
                                        type: "accent-light",
                                        iconName: "history",
                                        text: a
                                    });
                                    var l = e.payload.ref.split("/")[2];
                                    l && (i.href += "/commits/" + l), i.text = "Pushed " + a + " commit(s) to " + s
                                }
                                i.href || (i.href = t.gUrl + "/" + t.gUser, i.text = e.type + " is not categorized yet")
                            }
                            n += '<li><a href="' + i.href + '" target="_blank" class="main-footer__link"><div class="badge-container">', r.forEach(function (e) {
                                n += '<span class="badge badge-' + e.type + " " + (e.classes || "") + '"><span ' + (e.iconAriaLabel ? 'aria-label="' + e.iconAriaLabel + '" ' : "") + 'class="icon icon-' + e.iconName + " badge-icon " + (e.text ? "" : "only") + '"></span>' + (e.text || "") + "</span>"
                            }), n += '</div><div class="main-footer__link-description">' + i.text + "</div></a></li>"
                        }), n
                    }
                }
            }, {
                key: "run",
                value: function (e) {
                    if (e) return setInterval(e, this.timeInterval)
                }
            }, {
                key: "init",
                value: function () {
                    var e = this;
                    this.isInitialized || (Object.keys(this.gReqTypes).forEach(function (t) {
                        t = e.gReqTypes[t], e.getResources(e.createURI(t), function (n) {
                            Array.isArray(n) ? localStorage.setItem(t.name, JSON.stringify(n)) : n = JSON.parse(localStorage.getItem(t.name)), "Starred" === t.name && n.sort(function (e, t) {
                                return t.stargazers_count - e.stargazers_count
                            }), n = n.slice(0, t.items), t.htmlElement = document.querySelector(t.htmlSelector), t.htmlElement && (t.htmlElement.innerHTML = e.createStrTemplate(n))
                        })
    ...
    n.ready(function () {
        ...
        t.init();
        var n = new h;
        n.init(), r("lg") || n.setCallback(function () {
            t.close()
        });
        var i = new p;
        i.init(), (new f).init();
        var a = new g;
        a.init(), (new m).init(), (new v).init(), window.addEventListener("scroll", s(150, function () {
            e.headerHandling(), i.refresh()
        })), window.addEventListener("resize", o(600, function () {
            i.refresh(), a.currItems.forEach(function (e, t) {
                a.addStyles(e, t)
            })
        }))
    })
